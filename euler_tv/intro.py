...
class Intro(Scene) :
    def construct(self) :
        # grid=ScreenGrid()
        text00 = TextMobject("e")
        text00.scale(15)
        text00.move_to(UP*1.2)
        text01 = TextMobject("e")
        text01.scale(4)
        text01.move_to(UP*3.25 + RIGHT*6.2)
        text10 = TextMobject("Euler TV")
        text10.scale(2)
        text10.move_to(DOWN*1.2)
        text11 = TextMobject("Euler TV")
        text11.scale(0.7)
        text11.move_to(DOWN*1.2 + UP*3.8 + RIGHT*6.2)
